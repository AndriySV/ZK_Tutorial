...
public class TodoListViewModel implements Serializable {
	...
	public void init() {
		...
		// you can use List directly, however use ListModelList provide
		// efficient control in MVVM
	...
	public void addTodo() {
		if (Strings.isBlank(subject)) {
			...
			// update the model, by using ListModelList, you don't need to
			// notify todoListModel change
	...
	@Command
	// @NotifyChange("selectedTodo") //use postNotifyChange() to notify
	// dynamically
	...
	public void deleteTodo(@BindingParam("todo") Todo todo) {
		...
		// update the model, by using ListModelList, you don't need to notify
		// todoListModel change
	...
	// the validator is the class to validate data before set ui data back to
	// todo
